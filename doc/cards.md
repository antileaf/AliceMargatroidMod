...
- [x] 逐客令 (Ultimatum)
  - 1费 攻击
  - 造成 8 点伤害，施加 2 层 **虚弱**。对所有同名敌人也会生效。**消耗**。
  - 升级后：改为施加 3 层 **虚弱**。
...
- [x] 冰冻射线 (Frost Ray)
  - 2费 攻击
  - 造成 11 点伤害。你的下一张具有 **消耗** 的攻击牌或技能牌在打出时不会被 **消耗**，而是进入弃牌堆。**消耗**。
  - 升级后：改为 1 费。
- [x] 翠绿射线 (Emerald Ray)
  - 2费 攻击
...
- [x] 投掷 (Throw)
  - 1费 攻击
  - **指令**：**回收** 目标 **人偶**，对随机敌人造成 7 点伤害。在一回合内使用 3 次后，才会进入弃牌堆。
  - 升级后：改为造成 9 点伤害。
- [x] 扑克戏法 (Poker Trick)
  - 1费 攻击
...
- [x] 圆桌人偶 (Doll of Round Table)
  - 2费 技能
  - 所有 **人偶** 获得 16 点格挡。本回合内，无法再从卡牌中获得格挡。**消耗**。
  - 升级后：改为 1 费。
- [x] 甜点 (Dessert)
  - 1费 技能
...
- [x] 弱者退散 (Scatter the Weak)
  - 2费 攻击
  - 造成 5 点伤害。如果对 **爪牙** 敌人造成了未被格挡的伤害，直接将其消灭。
  - 升级后：改为对所有敌人造成伤害。

### 技能 2 / 6
- [x] 书签 (Bookmark)
  - 3费 技能
  - 下回合结束后，获得一个额外的回合。如果你的手牌中没有相同的牌，则改为本回合结束后立刻获得。**消耗**。
  - 升级后：改为 2 费。
...
- [ ] 稻草人偶 (Straw Effigies)
  - 0费 技能
  - 召唤一个稻草人（作为敌人）。回合结束时，稻草人会自毁，对所有敌人造成等同于其已受到伤害的伤害。**消耗**。
  - 升级后：增加 **保留**。
...
- [x] 精神力 (Spiritual Power)
  - 1费 能力
  - 每当 **人偶** **行动** 时，对随机敌人造成 5 点伤害。
  - 升级后：改为 7 点伤害。
- [ ] 不知道叫什么名字
  - 2费 能力
  - 回合开始时，随机打出抽牌堆中的一张攻击牌。
  - 升级后：改为 1 费。
- [x] 统御 (Tyrant)
  - X费 能力
