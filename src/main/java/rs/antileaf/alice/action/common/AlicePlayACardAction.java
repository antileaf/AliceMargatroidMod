...
// Thanks to 332 (author of the mod Tuner)
@Deprecated
public class AlicePlayACardAction extends AbstractGameAction {
    private boolean exhaustCards;
    private CardGroup group;
    private AbstractCard card;

    public AlicePlayACardAction(AbstractCard c, CardGroup group, AbstractCreature target, boolean exhausts) {
