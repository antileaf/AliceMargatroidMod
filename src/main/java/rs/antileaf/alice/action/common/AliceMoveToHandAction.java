...
public class AliceMoveToHandAction extends AbstractGameAction {
	...
	public AliceMoveToHandAction(CardGroup source, int amount, Predicate<AbstractCard> filter, Consumer<ArrayList<AbstractCard>> callback) {
		this.source = source;
	...
	public AliceMoveToHandAction(CardGroup source, int amount, Predicate<AbstractCard> filter) {
		this(source, amount, filter, null);
	}
	
	public AliceMoveToHandAction(CardGroup source, int amount) {
