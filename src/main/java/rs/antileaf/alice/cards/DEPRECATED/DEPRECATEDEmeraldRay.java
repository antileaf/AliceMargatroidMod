...
@Deprecated
public class DEPRECATEDEmeraldRay extends AbstractAliceCard {
	public static final String SIMPLE_NAME = DEPRECATEDEmeraldRay.class.getSimpleName();
//	public static final String ID = AliceSpireKit.makeID(SIMPLE_NAME);
	...
	public AbstractCard makeCopy() {
		return new DEPRECATEDEmeraldRay();
	}
