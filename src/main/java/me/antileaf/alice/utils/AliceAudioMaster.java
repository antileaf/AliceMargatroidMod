...
public class AliceAudioMaster {
	...
	public static final String ARIS_MAID_SELECT_1 = "AliceMargatroid:ARIS_MAID_SELECT_1";
	public static final String ARIS_MAID_SELECT_2 = "AliceMargatroid:ARIS_MAID_SELECT_2";
	...
	public static void init() {
		...
		BaseMod.addAudio(ARIS_MAID_SELECT_1, "AliceMargatroidMod/audio/charSelect/ARIS_MAID_1.wav");
		BaseMod.addAudio(ARIS_MAID_SELECT_2, "AliceMargatroidMod/audio/charSelect/ARIS_MAID_2.ogg");
