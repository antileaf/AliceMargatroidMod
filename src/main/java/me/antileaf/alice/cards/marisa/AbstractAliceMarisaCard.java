...
//		card.setPortraitTextures(imgPaths.small, imgPaths.large);
	...
	public static class ImgPaths {
		...
		public static ImgPaths ofAlternative(String name) {
			return new ImgPaths(
					AliceHelper.getImgFilePath("Marisa/cards", name),
					AliceHelper.getImgFilePath("Marisa/cards", name + "_p"),
					true
			);
		}
		...
		public static ImgPaths ofOriginal(String name) {
			return new ImgPaths(
					AliceHelper.getImgFilePath("Marisa/cards", name + "_original"),
					AliceHelper.getImgFilePath("Marisa/cards", name + "_original_p"),
					false
			);
		}
	...
	public static class BackgroundPaths {
		...
		public static BackgroundPaths ofPackMaster() {
			return new BackgroundPaths(
					AliceHelper.getImgFilePath("Marisa_PackMaster/512", "attack"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/1024", "attack"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/512", "skill"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/1024", "skill"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/512", "power"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/1024", "power"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/512", "orb"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/1024", "orb"),
					AliceHelper.getImgFilePath("Marisa_PackMaster/512", "orbIcon"),
					true
			);
		}
		...
		public static BackgroundPaths ofMarisa() {
			return new BackgroundPaths(
					AliceHelper.getImgFilePath("Marisa/512", "attack"),
					AliceHelper.getImgFilePath("Marisa/1024", "attack"),
					AliceHelper.getImgFilePath("Marisa/512", "skill"),
					AliceHelper.getImgFilePath("Marisa/1024", "skill"),
					AliceHelper.getImgFilePath("Marisa/512", "power"),
					AliceHelper.getImgFilePath("Marisa/1024", "power"),
					AliceHelper.getImgFilePath("Marisa/512", "orb"),
					AliceHelper.getImgFilePath("Marisa/1024", "orb"),
					AliceHelper.getImgFilePath("Marisa/512", "orbIcon"),
					false
			);
		}
