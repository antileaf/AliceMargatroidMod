...
public class AliceSelectCardsInHandAction extends AbstractGameAction {
	...
	public AliceSelectCardsInHandAction(int amount, String textForSelect, boolean anyNumber, boolean canPickZero, Predicate<AbstractCard> cardFilter, Consumer<List<AbstractCard>> callback, boolean returnToHand) {
