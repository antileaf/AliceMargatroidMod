...
public class AliceHoveredTargets {
	...
	public static final AliceHoveredTargets NONE = new AliceHoveredTargets();
	public static final AliceHoveredTargets PLAYER = new AliceHoveredTargets() {{ player = true; }};
